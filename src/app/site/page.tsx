  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center md:-mt-[60px]">
          <Image
          ...
          />
          <div className="bottom-0 top-[50%] left-0 right-0 bg-gradient-to-t dark:from-background absolute z-10" />
        </div>
      </section>

      <section className="flex flex-col items-center justify-center gap-4 md:mt-60">
