...
const UserDetails = ({ id, type, userData, subAccounts }: Props) => {
    const [subAccountsPermissions, setSubAccountsPermissions] = useState<UserWithPermissionsAndSubAccounts>(null)
    ...
    const onChangePermission = async (
        ...
        if (type === 'agency') {
            await saveActivityLogsNotification({
                ...
                description: `Gave ${userData?.name} access to | ${subAccountsPermissions?.Permissions.find(
